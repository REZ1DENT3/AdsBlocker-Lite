...
var blockerRulesCount=0;var hostname=window.document.domain;if(hostname.substr(0,4)=='www.'){hostname=hostname.substr(4)}
...
return this}
var storageParameters={rules:[],rulesOnline:[],rulesData:[],apiKey:"",whitelisted:[]};function adsRulesOnline(){if(document.querySelector('#whitelisted').value==''){document.querySelector('#ads-rules-online').setAttribute('disabled',!0)}
