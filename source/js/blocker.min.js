...
if(rules.length){$rules=$(rules.join(', '));if($rules.length){blockerRulesCount+=$rules.length;$rules.adsBlock();if(blockerRulesCount){chrome.runtime.sendMessage({name:"setBadgeText",text:''+blockerRulesCount})}
