...
document.documentElement.appendChild(script)};var blockerCount=0;var blockerRulesCount=0;var timerEps=5;var t1=(new Date()).getTime()-timerEps;var hostname=window.document.domain;if(hostname.substr(0,4)=='www.'){hostname=hostname.substr(4)}
...
for(var i=0;i<_rules.length;++i){rules.push(_rules[i])}
