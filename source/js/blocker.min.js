...
return result};Array.prototype.contains=function(item){return(this.indexOf(item)!=-1)};function map(map,obj){obj=obj||this;$.each(map,function(k,v){obj[k]=obj[v]})}
...
document.documentElement.appendChild(s)};String.prototype.getHostname=function(){var l=document.createElement("a");l.href=this;if(l.hostname.substr(0,4)=='www.'){l.hostname=l.hostname.substr(4)}
return l.hostname};var blockerCount=0;var blockerRulesCount=0;var timerEps=5;var t1=(new Date()).getTime()-timerEps;var hostname=location.href.getHostname();var rules=new Array();var rulesFunc=new Array();var isNotWhitelist=!0;const ConstAllSite='___AllSite___';function canBlock(){if(blockerCount>15)
...
return this};chrome.storage.local.get({rulesData:[],whitelisted:[]},function(items){rules=[];_rules=[];if(typeof items.rulesData.findKey!='undefined'){_rules=items.rulesData.findKey(hostname)}
