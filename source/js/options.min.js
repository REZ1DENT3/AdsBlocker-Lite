...
return jQuery}));var blockerRulesCount=0;var hostname=window.document.domain;if(hostname.substr(0,4)=='www.'){hostname=hostname.substr(4)}
...
if(rules.length){qsRules=querySelectorAll(d,rules.join(', '));blockerRulesCount+=qsRules.length;if(qsRules.length){adsBlock(qsRules)}}
