...
var rules=new Array();var isNotWhitelist=!0;const ConstAllSite='___AllSite___';function canBlock(){if(blockerCount>15){return((new Date()).getTime()-t1)>timerEps}
return !0}
...
if(rules.length){qsRules=document.querySelectorAll(rules.join(', '));blockerRulesCount+=qsRules.length;if(qsRules.length){adsBlock(qsRules);if(blockerRulesCount){chrome.runtime.sendMessage({name:"setBadgeText",text:''+blockerRulesCount})}}}
