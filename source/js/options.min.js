...
rulesData[_hostname].push(rule)});chrome.storage.local.set({rules:dataRules,rulesOnline:[],rulesData:rulesData,apiKey:apiKey,whitelisted:whitelisted},function(){$('#model-success').modal('show');if($('#api-key').val().trim()==''){$('#ads-rules-online').attr('disabled','disabled')}
